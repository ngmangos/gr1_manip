...
# code /workspace/isaaclab/_isaac_sim/kit/python/lib/python3.11/site-packages/rsl_rl/runners/on_policy_runner.py
...
class OnPolicyRunner:
    ...
    def log(self, locs: dict, width: int = 80, pad: int = 35):
        ...
        if len(locs["rewbuffer"]) > 0:
            ...
            self.mean_reward_buffer.append(statistics.mean(locs["rewbuffer"]))
    ...
    def save(self, path: str, infos=None):
        ...
        x_coords = np.arange(len(self.mean_reward_buffer))
        plt.plot(x_coords,self.mean_reward_buffer)
